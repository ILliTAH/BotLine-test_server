...
const char* host = "http://botdynamic.herokuapp.com/bot.php";
#define APPID   "bottestlinechat"     //change this to your APPID
#define KEY     "eaj0GHBnZ1UK1E7"     //change this to your KEY
#define SECRET  "K9o979urpnlJ5qNeaRPJUSXHe"     //change this to your SECRET
